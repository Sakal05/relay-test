...
exports.main = async function (signer, recipient, contractAddress) {
  ...
  const balance = await rewardContract.balanceOf(relayer);

  // Send funds to recipient if non zero
  if (balance.gt(0)) {
    const tx = await rewardContract.transfer(recipient, balance.toString());
...
exports.handler = async function (credentials) {
  ...
  const contractAddress = "0xD9db6B7E318FA998244Df7AC96f4Cc273174dA6F";
